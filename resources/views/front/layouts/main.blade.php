...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('front/assets/images/logo/favicon-32x32.png')}}" type="image/x-icon">
    <!-- Bootstrap 5 Css -->
    <link rel="stylesheet" href="{{asset('front/assets/css/bootstrap.5.1.1.min.css')}}">
    <!-- Google fonts -->
    ...
    <!--  Ui Tabs Css -->
    <link rel="stylesheet" href="{{asset('front/assets/css/plugin/jquery-ui.min.css')}}">
    <!-- Magnific-popup Css -->
    <link rel="stylesheet" href="{{asset('front/assets/css/plugin/magnific-popup.css')}}">
    <!-- Nice Select Css -->
    <link rel="stylesheet" href="{{asset('front/assets/css/plugin/nice-select.v1.0.css')}}">
    <!-- Animate Css -->
            ...
            <div class="d-lg-block d-none">
                <div class="row g-0 position-relative">
                    <div class="col-lg-3 d-flex align-items-center justify-content-center border-rit ">
                        <div class="logo"> <a href="index.html"> <img src="{{asset('front/assets/images/logo/logo.png')}}" alt=""> </a>
                        </div>
                    </div>
                                                                    ...
                                                                    <div class="col-xl-6 col-lg-5">
                                                                        <div class="content"> <a
                                                                                ...
                                                                                class="thumb d-block"> <img
                                                                                    src="{{asset('front/assets/images/home-two/products-v5-img21.png')}}"
                                                                                    alt=""> </a> <a
                                                                                href="shop-details-1.html"
                                                                                class="title d-block">
    ...
    <div class="sticy-header">
            ...
            <div class="mobile-menu__menu-top border-bottom-0">
                <div class="container">
                    <div class="row">
                        <div class="menu-info d-flex justify-content-between align-items-center">
                            <div class="menubar"> <span></span> <span></span> <span></span> </div> <a
                                href="index.html" class="logo"> <img src="{{asset('front/assets/images/logo/logo.png')}}" alt=""> </a>
                            <div class="cart-holder">
                                <a href="#0" class="cart cart-icon position-relative">
                                    <i class="flaticon-shopping-cart"></i>
                                </a>
        ...
        <div class="container position-relative d-lg-block d-none">
            <div class="d-flex align-items-center justify-content-between"> <a href="index.html" class="logo me-2">
                    <img src="{{asset('front/assets/images/logo/logo.png')}}" alt=""> </a>
                <div class="mega-menu-default mega-menu d-lg-block d-none">
                    <div class="container ">
                        <div class="row">
                            <nav>
            ...
            <div class="sidebar-textwidget">
                <div class="sidebar-info-contents">
                    <div class="content-inner">
                        <div class="logo"> <a href="index.html"><img src="{{asset('front/assets/images/logo/logo-2.png')}}" alt=""></a>
                        </div>
...
<footer class="footer-default footer-3 ">
    <div class="footer-default__shap_1 position-absolute "> <img src="{{asset('front/assets/images/shape/footer-shape-1.png')}}"
                                                                 alt=""> </div>
    <!--Start Footer-->
        ...
        <div class="container">
            <div class="footer_bottom_content">
                ...
                <div class="footer-payment wow fadeInUp animated">
                    <a href="#0"> <img src="{{asset('front/assets/images/home-four/method-1.jpg')}}" alt="payment"> </a>
                    <a href="#0"> <img src="{{asset('front/assets/images/home-four/method-2.jpg')}}" alt="payment"> </a>
                    <a href="#0"> <img src="{{asset('front/assets/images/home-four/method-3.jpg')}}" alt="payment"> </a>
                    <a href="#0"> <img src="{{asset('front/assets/images/home-four/method-4.jpg')}}" alt="payment"> </a>
                </div>
            </div>
        </div>
    </div>
...
<!--==== Js Scripts Start ====-->
<!-- Jquery v3.6.0 Js -->
<script src="{{asset('front/assets/js/jqurey.v3.6.0.min.js')}}"></script> <!-- Popper v2.9.3 Js -->
<script src="{{asset('front/assets/js/popper.v2.9.3.min.js')}}"></script> <!-- Bootstrap v5.1.1 js -->
<script src="{{asset('front/assets/js/bootstrap.v5.1.1.min.js')}}"></script> <!-- jquery ui js -->
<script src="{{asset('front/assets/js/plugin/jquery-ui.min.js')}}"></script> <!-- Parallax js -->
<script src="{{asset('front/assets/js/plugin/jarallax.min.js')}}"></script> <!-- Isotope js -->
<script src="{{asset('front/assets/js/plugin/isotope.js')}}"></script> <!-- Slick Slider Js -->
<script src="{{asset('front/assets/js/plugin/slick.min.js')}}"></script> <!-- magnific-popup v2.3.4 Js -->
<script src="{{asset('front/assets/js/plugin/jquery.magnific-popup.min.js')}}"></script> <!-- Tweenmax v2.3.4 Js -->
<script src="{{asset('front/assets/js/plugin/tweenMax.min.js')}}"></script> <!-- Nice Select Js -->
<script src="{{asset('front/assets/js/plugin/nice-select.v1.0.min.js')}}"></script> <!-- Wow js -->
<script src="{{asset('front/assets/js/plugin/wow.v1.3.0.min.js')}}"></script> <!-- Wow js -->
